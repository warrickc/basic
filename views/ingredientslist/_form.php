...
<div class="ingredientslist-form">
    ...
    <?php
      $query = new query();
      $query->select(['ingredientid', 'ingredientname'])->from('ingredients')->where("ingredientid NOT IN (SELECT ingredientid FROM ingredientslist WHERE drinkid = $model->drinkid)")->groupby('ingredientname');
